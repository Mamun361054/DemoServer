package com.example.dorbesh.demoserver;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        houseImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,Image_Select.class);
    ...
    protected void registerOwnerMember(final String image, final String name, String url) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                errorMsg+"err", Toast.LENGTH_LONG).show();
                    }
    ...
    void fetchingBannerData(){
        ...
        JsonArrayRequest jar = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                Picasso.with(MainActivity.this).load(link).into(houseImg);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
    ...
    void fetchingMemOneData(final ImageView img, final TextView txt, String url){
        ...
        JsonArrayRequest jar = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                Picasso.with(MainActivity.this).load(link).into(img);
                txt.setText(name);
            }
        }, new Response.ErrorListener() {
            @Override
